...
public class ItemListActivity extends AppCompatActivity {
    ...
    private void initComponents(){
        ...
        categories.put("प्राणी", "catAnimals");
        categories.put("प्रश्न", "catPronouns");
        categories.put("नैसर्गिक घटना ", "catNature");
        categories.put("कुटुंब", "catFamily");
        categories.put("फळे आणि भाज्या", "catFruits");
        categories.put("शुभेच्छा", "catGreetings");
        categories.put("व्यवसाय", "catProfession");
        categories.put("भावना", "catEmotions");
        categories.put("संख्या", "catNumbers");
        categories.put("कपडे", "catClothes");
        categories.put("बाराखडी", "catAlphabet");
        categories.put("रंग", "catColors");
        ...
        try {
            ...
            Toast.makeText(getApplicationContext(), "एक त्रुटी आली !!!", Toast.LENGTH_LONG).show();
        }
